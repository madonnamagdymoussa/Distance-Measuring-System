...
#define TIMER0_OVF       (0)      /* Index zero  */
#define TIMER0_COMP      (1)          /* Index one  */
#define TIMER1_OVF       (2)          /* Index two  */
#define TIMER1_COMPA     (3)            /* Index three  */
#define TIMER1_COMPB     (4)          /* Index four  */
#define TIMER1_CAPT      (5)          /* Index five  */
#define TIMER2_OVF       (6)           /* Index six  */
#define TIMER2_COMP      (7)          /* Index seven  */
