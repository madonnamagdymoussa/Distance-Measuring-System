...
typedef enum{
	LCD_RS_PORT_ID   =  PORTB_ID,
	LCD_RW_PORT_ID   =  PORTB_ID,
	LCD_E_PORT_ID    =  PORTB_ID,
	LCD_DATA_PORT_ID =  PORTA_ID

}HardwarePortLCD_t;

typedef enum{
	LCD_RS_PIN_ID  =  PIN0_ID,

    LCD_RW_PIN_ID  =  PIN1_ID,

   LCD_E_PIN_ID   =  PIN2_ID
